...
RUN CGO_ENABLED=0 GOOS=linux go build -o /bin/marketplace-api ./cmd/marketplace-api
...
COPY --from=builder /bin/marketplace-api /app/marketplace-api
USER appuser
EXPOSE 8080
ENTRYPOINT ["/app/marketplace-api"]
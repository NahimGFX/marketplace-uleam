...
func (m *comunidadRepoMock) ActualizarMessage(id int, msg models.Message) (models.Message, bool) {
...
func (m *comunidadRepoMock) CrearMision(mission models.Mission) models.Mission {
	args := m.Called(mission)
	return args.Get(0).(models.Mission)
}

func (m *comunidadRepoMock) ActualizarMision(id int, mission models.Mission) (models.Mission, bool) {
...
func (m *comunidadRepoMock) ActualizarUserMission(id int, um models.UserMission) (models.UserMission, bool) {
	args := m.Called(id, um)
	return args.Get(0).(models.UserMission), args.Bool(1)
}

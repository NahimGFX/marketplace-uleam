...
func (s *Server) ListarCategoria(w http.ResponseWriter, _ *http.Request) {
	RespondJSON(w, http.StatusOK, s.Categorias.Listar())
}

// ObtenerCategoria atiende GET /api/v1/categorias/{id}.
func (s *Server) ObtenerCategorias(w http.ResponseWriter, r *http.Request) {
...
func (s *Server) CrearCategorias(w http.ResponseWriter, r *http.Request) {
...
func (s *Server) ActualizarCategorias(w http.ResponseWriter, r *http.Request) {
	id, err := strconv.Atoi(chi.URLParam(r, "id"))
	if err != nil {
		RespondError(w, http.StatusBadRequest, "id debe ser un número entero")
		return
...
func (s *Server) BorrarCategorias(w http.ResponseWriter, r *http.Request) {
	id, err := strconv.Atoi(chi.URLParam(r, "id"))
	if err != nil {
		RespondError(w, http.StatusBadRequest, "id debe ser un número entero")
		return
